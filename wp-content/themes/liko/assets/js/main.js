...
$(window).on("load", function () {
	$(".anim-zoomin").each(function() {
		...
		// Add wrap <div>.
		if (!$(this).parent().hasClass("anim-zoomin-wrap")) {
			$(this).wrap('<div class="anim-zoomin-wrap"></div>');
		}

		// Add overflow hidden.
		$(this).parent(".anim-zoomin-wrap").css({ overflow: "hidden" });

		var $this = $(this);
		var $asiWrap = $this.closest(".anim-zoomin-wrap");
...
// filter click
$(document).on("click", ".portfolio-filter.tp-el-filter-btn button", function () {
	setTimeout(function () {
		$(".row.grid .grid-item:visible .anim-zoomin").each(function () {
			gsap.set(this, {
				autoAlpha: 1,
				scale: 1,
				clearProps: "all"
